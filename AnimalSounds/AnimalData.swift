...
let farmAnimals = AnimalCategory(name: "Farm Animals", animals: [
    ...
    Animal(uuid: UUID(), name: "Horse", thumbnail: "horseThumbnail", imageSoundMap: ["horse1": "horseSound1", "horse2": "horseSound2"], isPremium: true),
    Animal(uuid: UUID(), name: "Sheep", thumbnail: "sheepThumbnail", imageSoundMap: ["sheep1": "sheepSound1", "sheep2": "sheepSound2"], isPremium: true),
    Animal(uuid: UUID(), name: "Goat", thumbnail: "goatThumbnail", imageSoundMap: ["goat1": "goatSound1", "goat2": "goatSound2"], isPremium: false),
    Animal(uuid: UUID(), name: "Rooster", thumbnail: "roosterThumbnail", imageSoundMap: ["rooster1": "roosterSound1", "rooster2": "roosterSound2"], isPremium: true),
...
let wildAnimals = AnimalCategory(name: "Wild Animals", animals: [
    ...
    Animal(uuid: UUID(), name: "T-Rex", thumbnail: "trexThumbnail", imageSoundMap: ["trex1": "trexSound1", "trex2": "trexSound2"], isPremium: true),
    Animal(uuid: UUID(), name: "Elephant", thumbnail: "elephantThumbnail", imageSoundMap: ["elephant1": "elephantSound1", "elephant2": "elephantSound2"], isPremium: true),
    ...
    Animal(uuid: UUID(), name: "Dolphin", thumbnail: "dolphinThumbnail", imageSoundMap: ["dolphin1": "dolphinSound1", "dolphin2": "dolphinSound2"], isPremium: true),
    ...
    Animal(uuid: UUID(), name: "Hyena", thumbnail: "hyenaThumbnail", imageSoundMap: ["hyena1": "hyenaSound1", "hyena2": "hyenaSound2"], isPremium: true),
    Animal(uuid: UUID(), name: "Wolf", thumbnail: "wolfThumbnail", imageSoundMap: ["wolf1": "wolfSound1", "wolf2": "wolfSound2"], isPremium: true),
...
let birds = AnimalCategory(name: "Birds", animals: [
    ...
    Animal(uuid: UUID(), name: "Raven", thumbnail: "ravenThumbnail", imageSoundMap: ["raven1": "ravenSound1", "raven2": "ravenSound2"], isPremium: true),
    ...
    Animal(uuid: UUID(), name: "Peacock", thumbnail: "peacockThumbnail", imageSoundMap: ["peacock1": "peacockSound1", "peacock2": "peacockSound2"], isPremium: true),
    Animal(uuid: UUID(), name: "Owl", thumbnail: "owlThumbnail", imageSoundMap: ["owl1": "owlSound1", "owl2": "owlSound2"], isPremium: true),
    Animal(uuid: UUID(), name: "Hawk", thumbnail: "hawkThumbnail", imageSoundMap: ["hawk1": "hawkSound1", "hawk2": "hawkSound2"], isPremium: true),
